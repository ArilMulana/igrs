...
<form class = "form-horizontal" <?php echo form_open('cms/artikel/update/'.$artikel_item['id_artikel']); ?>>
  ...
  <div class="form-group">
   ...
   <div class="form-group">
    ...
    <div class="col-sm-10">
     <input id="judul" name="judul" type="text" maxlength="100" class="form-control" placeholder="" value="<?php echo $artikel_item['judul']; ?>"><span id="count" class="label label-info"> </span> 
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <div class="box">
          <textarea id="isi" name="isi" class="textarea" placeholder="" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo $artikel_item['isi']; ?></textarea>
