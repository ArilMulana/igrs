...
class Artikel extends CI_Controller {
  ...
  public function view($slug = NULL)
	...
	public function create(){
		...
		$this->form_validation->set_rules('berita_judul', 'Judul', 'required', array('required'=>'%s Harus diisi'));
		$this->form_validation->set_rules('berita_teks', 'Isi', 'required', array('required'=>'%s Harus diisi'));
